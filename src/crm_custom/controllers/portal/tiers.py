...
class PortalTiersController(http.Controller):
    ...
    def _serialize_tier(self, tier):
        ...
        return {
            ...
            "point_multiplier_mon": tier.point_multiplier_mon,
            "point_multiplier_tue": tier.point_multiplier_tue,
            "point_multiplier_wed": tier.point_multiplier_wed,
            "point_multiplier_thu": tier.point_multiplier_thu,
            "point_multiplier_fri": tier.point_multiplier_fri,
            "point_multiplier_sat": tier.point_multiplier_sat,
            "point_multiplier_sun": tier.point_multiplier_sun,
            "point_multiplier_apply_receipt": tier.point_multiplier_apply_receipt,
            "point_multiplier_apply_zortout": tier.point_multiplier_apply_zortout,
            "point_multiplier_apply_omisell": tier.point_multiplier_apply_omisell,
